...
// function drawHandRight(data) {
//     drawHand('right', data);
// }

// function drawHandLeft(data) {
//     drawHand('left', data);
// }
...
function initKinectron() {
    ...
    // kinectron.startTrackedJoint(kinectron.HANDRIGHT, drawHandRight);

    // init the hand tracking with drawJoint as callback
    // kinectron.startTrackedJoint(kinectron.HANDLEFT, drawHandLeft);
}
